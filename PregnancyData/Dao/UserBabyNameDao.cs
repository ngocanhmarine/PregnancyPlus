...
namespace PregnancyData.Dao
{
	public class UserBabyNameDao
	{
		...
		public IQueryable<preg_user_baby_name> GetListItem()
		{
			return connect.preg_user_baby_name;
		}

		public IQueryable<preg_user_baby_name> GetItemByID(int user_id, int baby_name_id)
		{
			return connect.preg_user_baby_name.Where(c => c.user_id == user_id && c.baby_name_id == baby_name_id);
		}

		public IQueryable<preg_user_baby_name> GetItemByUserID(int user_id)
		{
			return connect.preg_user_baby_name.Where(c => c.user_id == user_id);
		}

		public IQueryable<preg_user_baby_name> GetItemByParams(preg_user_baby_name data)
		{
			IQueryable<preg_user_baby_name> result = connect.preg_user_baby_name;
		...
		public void DeleteData(preg_user_baby_name item)
		{
